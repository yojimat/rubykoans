...
class AboutControlStatements < Neo::Koan
  ...
  def test_if_statements_return_values
    ...
    # just if statements.
    # Interesting, what about statements that does not 'return', what does it return? nil?
  end
  ...
  def test_if_statements_with_no_else_with_false_condition_return_value
    ...
    # So nil it is the default value for return when there is no value to return.
  end
